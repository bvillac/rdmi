...
function runServer() {
    ...
    //var Signaling = require('./node_modules/rtcmulticonnection-v3/Signaling-Server.js')(app, function(socket) {
    //require('../node_modules/rtcmulticonnection-v3/Signaling-Server')(app, function(socket) {
    //require(__dirname + 'Signaling-Server.js')(app, function(socket) {
    require('./node_modules/rtcmulticonnection-v3/Signaling-Server')(app, function(socket) {
        try {

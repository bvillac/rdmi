...
var options = {
    key: fs.readFileSync(path.join(__dirname, resolveURL('fake-keys/prueba.utimpor.pem'))),
    cert: fs.readFileSync(path.join(__dirname, resolveURL('fake-keys/prueba.utimpor.crt')))
};

/*
var options = {
    key: fs.readFileSync(path.join(__dirname, resolveURL('fake-keys/vs.server.pem'))),
    cert: fs.readFileSync(path.join(__dirname, resolveURL('fake-keys/vs.server.crt')))
};*/
...
//Quitar este block SI NO esta usando Config.json
/*try {
...
if (isUseHTTPs) {
    ...
    //app = require('https').Server(options,serverHandler);
...
function runServer() {
    ...
    require('./Signaling-Server.js')(app, function(socket) {
        try {
            var addr = app.address();
            console.log("new client connected"+addr.address);
